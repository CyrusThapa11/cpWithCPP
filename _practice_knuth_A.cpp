...
void solve() {
   ...
   if (vec_[1] == minn && vec_[n - 2] == maxx ) {
      cout << maxx - minn << nline;
      return;
   } else if (vec_[1] != minn && vec_[n - 2] != maxx ) {
      cout << min(vec_[n - 1] - vec_[1] , vec_[n - 2] - vec_[0] ) << nline;
      return;
   } else {
      if (vec_[0 ] == vec_[1] ) {
         cout << vec_[n - 2] - vec_[0] << nline;
      } else  cout << vec_[n - 1] - vec_[1] << nline;
   }
